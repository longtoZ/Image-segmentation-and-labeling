    ...
    ***************************************************************************** */ var r = function (
        ...
        var e = (B = (function (A, r) {
                ...
                return (
                    A.forEach(function (A, e) {
                        ...
                        if (4 !== t && 11 !== t)
                            return n.push(e), 31 === t ? B.push("strict" === r ? O : q) : t === AA || 29 === t ? B.push(J) : 43 === t ? ((131072 <= A && A <= 196605) || (196608 <= A && A <= 262141) ? B.push(q) : B.push(J)) : void B.push(t);
            ...
            (XA.prototype.consumeStringToken = function (A) {
                for (var e = "", t = 0; ; ) {
                    ...
                    92 !== B ||
                        (-1 !== (r = this._value[t + 1]) &&
                            void 0 !== r &&
                            (10 === r ? ((e += this.consumeStringSlice(t)), (t = -1), this._value.shift()) : hA(B, r) && ((e += this.consumeStringSlice(t)), (e += g(this.consumeEscapedCodePoint())), (t = -1)))),
                        t++;
                }
            }),
        ...
        es = function (A) {
            ...
            (this.topLeftBorderDoubleOuterBox = 0 < r || 0 < B ? ss(t.left + F / 3, t.top + l / 3, r - F / 3, B - l / 3, As.TOP_LEFT) : new Zn(t.left + F / 3, t.top + l / 3)),
                ...
                (this.bottomRightPaddingBox =
                    0 < o || 0 < i ? ss(t.left + Math.min(w, t.width - F), t.top + Math.min(g, t.height - u), Math.max(0, o - C), Math.max(0, i - u), As.BOTTOM_RIGHT) : new Zn(t.left + t.width - C, t.top + t.height - u)),
    ...
    var hs = function (Q, c, a, g) {
        ...
        Hs = function (A, e, t, r) {
            var B = [];
            return (
                $n(A) ? B.push(A.subdivide(0.5, !1)) : B.push(A), $n(t) ? B.push(t.subdivide(0.5, !0)) : B.push(t), $n(r) ? B.push(r.subdivide(0.5, !0).reverse()) : B.push(r), $n(e) ? B.push(e.subdivide(0.5, !1).reverse()) : B.push(e), B
            );
        },
        ps = function (A, e, t) {
            var r = e[0],
        ...
        bs =
            ...
            (Ds.prototype.renderReplacedElement = function (A, e, t) {
                ...
                t &&
                    0 < A.intrinsicWidth &&
                    0 < A.intrinsicHeight &&
                    ((r = ls(A)), (e = rs(e)), this.path(e), this.ctx.save(), this.ctx.clip(), this.ctx.drawImage(t, 0, 0, A.intrinsicWidth, A.intrinsicHeight, r.left, r.top, r.width, r.height), this.ctx.restore());
            }),
